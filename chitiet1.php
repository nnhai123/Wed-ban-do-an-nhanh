...
.content__heading{
     padding-top: 20px; /* Điều chỉnh giá trị theo ý muốn */
                                ...
                                <div class="col l-7">
                                    <div class="content-product__right">
                                        ...
                                        <div class="content-product__right-call">
                                            ...
                                            <span class="content-product__call-num">0962663956</span>
                                        </div>
                ...
                <div class="content__describe">
                    ...
                    <div class="content__describe-info">
                        <p class="content__describe-msg">
                            <b>Sản Phẩm :</b> <?php echo $row["tensp"] ?> <br>
                            <b>Kích thước:</b>  <?php echo $row["kichthuoc"] ?> <br>
                            <b>Giá trên bao gồm:</b> Phí VAT <br>
                        </p>
                        <p class="content__describe-msg">
