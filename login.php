...
<body>
    <form action="login.php" method="post" class="relog">
        <div class="relog-form">
            ...
            <p class="relog-form__title">Nếu bạn chưa có tài khoản,đăng ký <a href="dangki.php" class="relog-form__link">tại đây</a></p>
            <p class="relog-form__title">Nếu bạn là Admin, đăng nhập<a href="adminlogin.php" class="relog-form__link"> tại đây</a></p>
        </div>
</form>
</body>
</html>
