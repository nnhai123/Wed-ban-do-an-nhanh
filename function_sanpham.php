...
class sanpham extends ketnoi{
    ...
    function themsanpham(){
        $sql = "INSERT INTO `sanpham1`(`masp`, `nhom_id`, `tensp`, `mota`, `dongiacu`, `dongiamoi`,  `enable`,  `xuatxu`, `ngaydang`, `kichthuoc`, `nguoidang`)
    VALUES ('".$this->masanpham."','".$this->nhomid."','".$this->tensanpham."','".$this->mota."','".$this->dongiacu."','".$this->dongiamoi."', '".$this->enable."','".$this->xuatxu."', '".$this->ngaydang."','".$this->kichthuoc."','".$this->nguoidang."' )";
    $result = mysqli_query($this->conn, $sql);
