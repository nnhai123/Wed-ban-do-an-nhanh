...
<meta charset="UTF-8">
    ...
    <style>
        ...
        .container__cart-dad {
        padding-top: 100px; /* Điều chỉnh giá trị theo ý muốn */
        }
        tbody td {
            text-align: center;
            border: 1px solid #000;
    ...
    <!-- Shoping Cart Section Begin -->
        ...
        <div class="container">
            <div class="row">
                ...
                <h3 class="container-product__heading"style ="color:green;font-weight:700;font-family: 'Roboto';">GIỎ HÀNG</h3>
